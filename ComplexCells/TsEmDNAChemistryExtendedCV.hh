...
#ifndef TsEmDNAChemistryExtendedCV_hh
#define TsEmDNAChemistryExtendedCV_hh 1
...
class TsEmDNAChemistryExtendedCV
	: public G4VUserChemistryList,
	  public G4VPhysicsConstructor
{

public:
	explicit TsEmDNAChemistryExtendedCV();
	TsEmDNAChemistryExtendedCV(TsParameterManager* pM);

	virtual ~TsEmDNAChemistryExtendedCV();
