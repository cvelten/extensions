...
#ifndef TsScoreMoleculeTupleExtended_hh
#define TsScoreMoleculeTupleExtended_hh

#include "TsVNtupleScorer.hh"

class TsScoreMoleculeTupleExtended : public TsVNtupleScorer
{
public:
    TsScoreMoleculeTupleExtended(TsParameterManager *pM, TsMaterialManager *mM, TsGeometryManager *gM, TsScoringManager *scM, TsExtensionManager *eM,
                                 G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

    virtual ~TsScoreMoleculeTupleExtended() = default;
