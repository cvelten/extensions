...
#ifndef TsEmDNAChemistryCV_hh
#define TsEmDNAChemistryCV_hh 1
...
class TsEmDNAChemistryCV
	: public G4VUserChemistryList,
	  public G4VPhysicsConstructor
{

public:
	explicit TsEmDNAChemistryCV();
	TsEmDNAChemistryCV(TsParameterManager* pM);

	virtual ~TsEmDNAChemistryCV();
